...
Ainda segundo Miller, o equilíbrio dinâmico, considera a dinâmica do movimento da caminhada. Onde o \abrv[ZMP -- do inglês \textit{zero moment point}]{ZMP, do inglês \textit{zero moment point},} sempre fica sob a superfície de apoio. Desta forma, habilita-se o CoM movimentar-se para fora do ponto de apoio, mantendo o robô em uma espécie de ``queda controlada''. Assim, ela provê maiores velocidades de caminhada com maior eficiência. O ZMP é o ponto de apoio com o chão onde nenhum momento é criado no eixo horizontal \cite{kajita2008}.
