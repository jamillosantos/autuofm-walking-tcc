...
\textit{Arash} é um robô de 1,05 metros de altura e 20 \todo{Definir}\textit{DOFs} no total. Cada perna possui 2 \textit{DOFs} no pé, 1 \textit{DOF} no joelho e 3 \textit{DOFs} no quadril. Nos cada braço possui 3 \textit{DOFs}, sendo 2 no ombro e 1 no cotovelo. Por fim, no pescoço temos mais 2 \textit{DOFs}.
